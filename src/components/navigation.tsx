    ...
    return(
        <div
            ...
            <div
                ...
                className={`hidden lg:block absolute top-1/30 right-0 rounded-full ${isOpen ? "":"w-2/3"}  h-4/5 bg-white dark:bg-black border-gray-500 border-2 cursor-pointer`}
            >
                <svg
                viewBox="0 0 100 80"
                width="20"
            ...
            <div className={`bg-white/80 dark:bg-black/80 ${isOpen ? "lg:w-13/14" : "lg:w-8/12"} h-screen lg:border-r border-gray-500`}>
                <div
