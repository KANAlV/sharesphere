      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Admin Announcements */}
            {user?.udata === "1" && (
             <NavItem label="Announcemnets" icon={AnnounceIcon} onClick={() => waitRedir("/announcements")} isOpen={isOpen} />
            )}
...
const AnnounceIcon = () => (
  <svg fill="#FFFFFF" height="24" width="24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" className="rotate-330"
	 viewBox="0 0 489.803 489.803">
  <g>
    <g>
