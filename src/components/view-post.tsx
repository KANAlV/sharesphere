        ...
        comments.map((comment, idx) => (
          <div key={idx}>
            <div className="flex ml-8 mx-4 w-full pb justify-between relative">
              ...
              {/* Comment content */}
              <div
                style={{ border: `0px solid ${fontcolor}` }}
                className={`${
                  comment.has_comments ? "border-l-2!" : "border-l-none"
                } flex-grow ml-5 p-4 pb-8 pl-8`}
              >
                <p style={{ color: fontcolor }} className="text-sm">
              ...
              {/* Likes / Dislikes / Reply */}
                ...
                {/* expand comments */}
                <div /* on click here to show code */ style={{background: details[0].theme}} className={`${comment.has_comments? "":"hidden"} ml-2.25 absolute w-6 h-6 self-end border-2 overflow-clip rounded-full cursor-pointer`}>
            ...
            <div className="relative ml-13 w-full">
              <div className="border-l-2 w-full h-10 bg-gray-700 rounded-b-2xl"/>
