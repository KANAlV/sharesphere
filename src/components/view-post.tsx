          ...
          <div key={idx}>
            <div className="flex ml-8 mx-4 w-full justify-between relative">
              ...
              <div
                ...
                style={{color: fontcolor, background: theme,  border: `2px solid ${fontcolor}`}}
                className={`${comment.has_comments? "":"hidden"} ml-3 absolute w-6 h-6 self-end border-2 overflow-clip rounded-full cursor-pointer`}>
