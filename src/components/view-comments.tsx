...
export default function PostView({ comment_id, myModData, post, details, userdata }: { comment_id: string, myModData:Mod|null, post: Post, details: Details[], userdata: UserData[] | null }) {
